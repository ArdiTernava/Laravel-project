    ...
    public function show(Product $product)
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($product->save()) {
            return redirect()->route('products.index')->with('status', 'Products was updated successfully.');
        }
    ...
    public function destroy($id)
    {
        $product = Product::findOrFail($id);
        if($product->delete()){
            return redirect()->route('products.index')->with('status', 'Product was delete successfully.');
        }
        return redirect()->back()->with('status', 'Something want wrong!');
    }
}
